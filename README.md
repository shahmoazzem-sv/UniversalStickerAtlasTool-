...
3. Paste the repository URL:
   ```text
   https://github.com/shahmoazzem-sv/UniversalStickerAtlasTool-.git
   ```
...
│   └── UniversalStickerAtlas.Runtime.asmdef  # UPM Assembly Definition
├── Editor/
│   ├── RoadSignDecalEditor.cs                 # Inspector Editor & Visual Picker
│   ├── RoadSignAtlasWindow.cs                # Editor Window Tool
│   └── UniversalStickerAtlas.Editor.asmdef   # UPM Assembly Definition
├── Shaders/
│   └── RoadSignAtlasURP.shader               # Custom URP Lit Shader
├── Tests/
│   ├── StickerAtlasTests.cs                  # NUnit Unit Tests
│   └── UniversalStickerAtlas.Tests.asmdef    # Assembly Definition
